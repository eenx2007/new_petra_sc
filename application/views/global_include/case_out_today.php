<script type="application/javascript">
	$(document).ready(function() {
		...
		var oTable =$('#case_out_today_table_db').dataTable(
			{
				"sDom": '<"top"if>rt',
				"bPaginate": false,
				"bLengthChange": false,
...
<div class="over_screen_title">Case Out Today</div>
<div class="over_screen_content">
<table class="main_table" id="case_out_today_table_db">
	<thead>
    <tr><th>No</th><th>Case ID</th><th>Serial Number</th><th>CSO</th><th>Engineer</th><th>Unit Type</th><th>Case Type</th></tr>
    </thead>
    <tbody>
