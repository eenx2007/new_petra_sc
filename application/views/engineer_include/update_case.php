	...
	$(document).ready(function() {
		...
		$('#request_part').click(function(){
			...
			$.post('<?php echo site_url('engineers/part_control/request_part');?>',
				...
				function(data)
				{
					message_alert('New Part Request Created!');
					$('#part_number').val('');
					$('#bad_part_sn').val('');
					$('#oem_part_sn').val('');
					$('#log_details').load('<?php echo site_url('engineers/case_control/get_case_log');?>/'+c_id);
...
<div class="innerbody" style="width:60%;">
    ...
    <div id="tabsnya" class="tabbed_area" style="width:90%;">
    	<ul class="tabs">
            ...
            <li><a href="javascript:void(0);" gototab="#part_request_tab" class="tab">Part Request</a></li>
        ...
        <div id="case_detail_tab" class="content_tab">
       		<table class="main_table">
                ...
                <tr><td>Name</td><td><input type="text" name="customer_name_text" id="customer_name_text" /></td></tr>
        ...
        <div id="part_request_tab" class="content_tab">
        	<table class="main_table">
            	<tr><td>Name Part</td><td><input type="text" id="part_number" name="part_number" /></td></tr>
                <tr><td>Reason</td><td><input type="text" id="bad_part_sn" name="bad_part_sn" /></td></tr>
                <tr><td>QTY</td><td><input type="text" id="oem_part_sn" name="oem_part_sn" /></td></tr>
               
                <tr><td colspan="2"><button id="request_part">Request</button></td></tr>
            </table>
        </div>
        ...
        <div id="log_info_tab" class="content_tab">
        	<table class="main_table">
                ...
                <tr><td><textarea name="new_log_entry" id="new_log_entry" style="height:150px;"></textarea></td></tr>
        ...
        <div id="force_update_tab" class="content_tab">
        	<table class="main_table">
            	<tr><td colspan="2">Make sure the unit is ready!</td></tr>
                <tr>
                	<td>
						<?php
							$last_status=array('9'=>'Ready to Test by QC','22'=>'Ready to transfer to RC');
							echo form_dropdown('last_status',$last_status,'','id="last_status"');
						?>
                    </td>
                    <td><button id="force_update">Change Status</button></td> 
                 </tr>
