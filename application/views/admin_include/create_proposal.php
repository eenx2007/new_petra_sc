<script type="text/javascript">
	$(document).ready(function(e) {
		...
		$('#detail_proposal_update').load('<?php echo site_url('admin_panel/det_proposal_update');?>/<?php echo $proposal_id;?>');
		$('#add_part_sale').click(function(){
			p_idnya=$('#proposal_id_hidden').val();
			partno=$('#part_sale_add').val();
			$.post('<?php echo site_url('admin_panel/add_detail_proposal');?>',
				{
					proposal_id:p_idnya,
					det_value:partno
				},
