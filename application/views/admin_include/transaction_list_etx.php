<table class="main_table">
                ...
                <?php $i=0;$total_debit=0;$total_credit=0; foreach($query as $rows): ?>
                	<?php if($rows->transaction_title<>"Income from Invoice I"): $i++; ?>
                	<tr>
                    	<td><?php echo $i;?></td>
                        ...
                        <td><?php echo print_r($rows->transaction_reff,true);?></td>
                    </tr>
                    <?php endif;?>
                <?php endforeach;?>
